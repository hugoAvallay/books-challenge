...
window.onload = function () {
    ...
    $('country').addEventListener('focus', function (e) {
        $('msgError-country').innerHTML = null
        this.classList.remove('is-invalid');
        this.classList.remove('is-valid')
    })
    ...
    $('country').addEventListener('blur', function (e) {
        ...
        switch (true) {
            case !this.value.trim():
                $('msgError-country').innerHTML = "El Pais es obligatorio.JS"
                this.classList.add('is-invalid')
                break;
            case this.value.trim().length < 2:
                $('msgError-country').innerHTML = "Mínimo dos letras";
                this.classList.add('is-invalid')
                break
            case !/^[ a-zA-ZñÑáéíóúÁÉÍÓÚ]+$/.test(this.value.trim()):
                $('msgError-country').innerHTML = "Solo se permiten letras";
                this.classList.add('is-invalid')
                break
            default:
                $('msgError-country').innerHTML = null;
